...
class tracking_apriltag(object):
	...
	# Save Data
	def get_data(self):
		f = open('/home/wanglab/catkin_ws/src/gimbal/data/2022.12.08/Metro60VeloAccele.csv', 'w')
	...
	def tag_image_callback(self, data_image):
		if len(data_image.detect_positions) >= 1:
			...
			if self.flag_image == 0:
				...
				self.TagPosImg_data[1].append(self.Position_old_image.x)
				self.TagPosImg_data[2].append(self.Position_old_image.y)
