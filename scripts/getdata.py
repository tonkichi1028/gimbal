...
class tracking_apriltag(object):
	...
	def image_process(self, input_image):
		...
		# GetData
		self.TagPosPreImg_data[0].append(self.time)
		self.TagPosPreImg_data[1].append(self.Position_predicted_image[0])
		self.TagPosPreImg_data[2].append(self.Position_predicted_image[1])
	...
	# Save Data
	def get_data(self):
		f = open('/home/wanglab/catkin_ws/src/gimbal/data/2022.11.29/data0.csv', 'w')
