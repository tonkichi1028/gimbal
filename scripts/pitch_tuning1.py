...
class tracking_apriltag(object):
	...
	def get_data(self):
		...
		f = open('/home/wanglab/catkin_ws/src/gimbal/data/2022.12.09/pitch ' + 'P_%1.5f'%p + 'I_%1.5f'%i + 'D_%1.5f'%d + '.csv', 'w')
	...
	def get_pitch_graph(self):
		...
		fig.savefig("/home/wanglab/catkin_ws/src/gimbal/Image/2022.12.09/pitch " + "P_%1.5f"%p + "I_%1.5f"%i + "D_%1.5f"%d + ".png", bbox_inches='tight')
